...
#define NVM_BASE_ADDR 0x00104000			// base address of usable NVM

//**** persistence singleton ****

typedef struct nvmSingleton {
	uint32_t base_addr;					// NVM base address
	uint32_t profile_base;				// NVM base address of current profile]
	uint32_t address;
	float tmp_value;
