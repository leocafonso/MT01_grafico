...
#define TRAVELX	CREM_HELI
#define TRAVELY	CREM_HELI
#define TRAVELZ	3
...
#define X_JERK_MAX				800				// xjm		yes, that's "5 billion" mm/(min^3)
#define X_JERK_HOMING			800				// xjh
...
#define Y_JERK_MAX				800
#define Y_JERK_HOMING			800				// xjh
