...
enum{
	...
	IMG_PAR_MAQ_FORMAT_PRESSED = 158,
	IMG_PAR_MAQ_FORMAT = 159,
	IMG_PAR_MAQ_JERKX_PRESSED = 160,
	IMG_PAR_MAQ_JERKX = 161,
	IMG_PAR_MAQ_JERKY_PRESSED = 162,
	IMG_PAR_MAQ_JERKY = 163,
	IMG_PAR_MAQ_TOL_ARCO_PRESSED = 168,
	IMG_PAR_MAQ_TOL_ARCO = 169,
	IMG_PAR_MAQ_VEL_X_PRESSED = 170,
	IMG_PAR_MAQ_VEL_X = 171,
	IMG_PAR_MAQ_VEL_Y_PRESSED = 172,
	IMG_PAR_MAQ_VEL_Y = 173,
	IMG_PAR_MAQ_VEL_Z_PRESSED = 174,
	IMG_PAR_MAQ_VEL_Z = 175,
	IMG_UN_MM_MIN3 = 176,
	IMG_SEM_ARQUIVO =  177,
